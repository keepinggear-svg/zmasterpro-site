...
- [支先森校服渠道补购系统（当前访问地址）](https://zhixiansheng-xiaofu.keepinggear689308.chatgpt.site/)
- 计划启用的国内访问地址：`https://xiaofu.zmasterpro.com/`（域名解析完成后开放）

校服系统的产品、渠道二维码、订单和代理结算功能使用独立代码库维护，不与官网源码或客户订单数据混放。
